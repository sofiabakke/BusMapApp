 ...
 */
public class RuterHandler implements RouteMarkerHandler{
    private static GoogleMap busMap;
    private ArrayList<RuterVehicleMarker> vehicleMarkers;
    private ArrayList<StopMarker> stopMarkers;
    private Thread updateThread;
    private boolean running = true;
    private int lastLineID = 0;

    public RuterHandler(GoogleMap busMap){
        this.busMap = busMap;
        ...
        mainHandler.post(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    RuterVehicleMarker marker = new RuterVehicleMarker(
